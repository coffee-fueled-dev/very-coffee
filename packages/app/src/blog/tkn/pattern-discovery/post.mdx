...
The key insight: by checking if extended patterns exist in the dictionary (LZ-style inclusion), the algorithm naturally segments at boundaries where patterns become novel, discovering repetition and structure without explicit pattern matching.
