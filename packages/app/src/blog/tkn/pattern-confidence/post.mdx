...
We can compute confidence with various methods, but a simple approach is to measure each pattern's weighted connectivity with the following formula:
...
_\*This all happens in your browser, I don't save your files anywhere_

[Read the source code](https://github.com/coffee-fueled-dev/very-coffee/blob/main/packages/app/src/blog/tkn/pattern-confidence/demos/pattern-confidence.tsx)
